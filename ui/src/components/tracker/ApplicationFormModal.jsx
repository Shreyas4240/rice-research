...
const DEPT_OPTIONS = [
  ...
  { value: 'chbe',           label: 'Chem & Biomolecular'         },
  { value: 'cee',            label: 'Civil & Environmental'       },
  { value: 'cmor',           label: 'Comp Applied Math & OR'      },
  { value: 'cs',             label: 'Computer Science'            },
  { value: 'ece',            label: 'Electrical & Computer'       },
  { value: 'msne',           label: 'Materials & NanoEng'         },
...
const inputCls = `w-full px-3 py-2 text-sm bg-white border border-stone-200 rounded-xl
  ...
  focus:ring-riceblue-300 focus:border-transparent transition-shadow`
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
          <div className="p-5 space-y-4">
            ...
            <Field label="Source Link">
              <input
                ...
                placeholder="https://engineering.rice.edu/…"
                className={inputCls}
              />
            </Field>
          ...
          <div className="sticky bottom-0 bg-white border-t border-stone-100 px-5 py-4
            ...
            <button
              type="submit"
              disabled={saving}
              className="px-5 py-2 bg-riceblue-700 text-ricewhite-100 text-sm font-semibold
                         rounded-xl hover:bg-riceblue-600 transition-colors
                         disabled:opacity-60 disabled:cursor-not-allowed shadow-sm
                         shadow-riceblue-900/20"
            >
