...
export default function NavBar() {
  ...
  return (
    <nav className="relative bg-ricewhite-50/95 backdrop-blur-sm border-b border-ricewhite-300 sticky top-0 z-50">
      {/* Maroon top accent */}
      <div className="absolute inset-x-0 top-0 h-[2.5px] bg-riceblue-700 pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-[54px] flex items-center justify-between">
        ...
        <Link to="/" className="flex items-baseline gap-0.5 select-none group">
          <span className="font-display italic text-riceblue-700 text-[20px] font-bold
                           leading-none group-hover:text-riceblue-600 transition-colors">
            Rice
          </span>
        ...
        <div className="flex items-center gap-0.5">
          ...
          <Link
            ...
            className={[
              'relative px-3 py-1.5 text-sm font-medium rounded-lg transition-colors duration-150',
              searchActive ? 'text-riceblue-700' : 'text-stone-500 hover:text-stone-900',
            ].join(' ')}
          >
            Search
          </Link>
          <Link
            ...
            className={[
              'relative px-3 py-1.5 text-sm font-medium rounded-lg transition-colors duration-150',
              discoverActive ? 'text-riceblue-700' : 'text-stone-500 hover:text-stone-900',
            ].join(' ')}
          >
            Discover
          </Link>
          <Link to="/saved" className={linkCls('/saved')}>
            ...
            {saved.length > 0 && (
              <span className="ml-1.5 inline-flex items-center justify-center
                               w-[18px] h-[18px] rounded-full bg-riceblue-700
                               text-ricewhite-50 text-[10px] font-bold leading-none">
          ...
          <Link to="/credits" className={linkCls('/credits')}>
            Credits
          </Link>
          ...
          <Link
            to="/discover"
            className="ml-3 px-4 py-1.5 bg-riceblue-700 text-ricewhite-100 text-[13px]
                       font-semibold rounded-lg hover:bg-riceblue-600 transition-colors
                       shadow-sm shadow-riceblue-900/20"
          >
            Get Matched →
          </Link>
        </div>
