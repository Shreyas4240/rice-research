...
export default function Saved() {
  ...
  return (
    <div className="min-h-[calc(100vh-54px)] bg-white w-full">
        ...
        {savedProfs.length > 0 && (
          <button
            ...
            className="text-sm text-stone-400 hover:text-red-600 transition-colors
                       border border-ricewhite-300 hover:border-red-200 px-3 py-1.5
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-7 py-3 bg-riceblue-700
                       hover:bg-riceblue-600 text-ricewhite-100 text-sm font-semibold
                       rounded-xl transition-colors shadow-sm shadow-riceblue-950/20"
          >
            Browse Faculty
          </Link>
        </div>
