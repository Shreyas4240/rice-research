  ...
  return (
    <div className="flex flex-col">
      ...
      {/* ══════════════════════════════════════════════════════
          HERO
      ══════════════════════════════════════════════════════ */}
      <section className="relative min-h-[91vh] flex items-center overflow-hidden bg-ricewhite-100">
        {/* Dot grid texture */}
        ...
        {/* Subtle vignette */}
        <div className="absolute inset-0 bg-gradient-to-r from-ricewhite-100 via-ricewhite-100/80
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-10 py-24 w-full">
          <div className="max-w-[640px]">
            ...
            <div className="hero-animate-1 flex items-center gap-2.5 mb-7">
              <span className="w-6 h-px bg-riceblue-700" />
              <span className="text-xs font-semibold text-riceblue-700 uppercase tracking-[0.18em]">
                Rice Engineering
              </span>
            </div>
            ...
            <h1 className="hero-animate-2 font-display font-bold text-stone-900
              ...
              Find where your<br />
              <em className="not-italic text-riceblue-700">curiosity</em>{' '}
              belongs.
            </h1>
            ...
            <div className="hero-animate-4 flex flex-col sm:flex-row gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2.5 px-8 py-3.5
                           bg-riceblue-700 text-ricewhite-100 rounded-xl font-semibold text-sm
                           hover:bg-riceblue-600 transition-all duration-200
                           shadow-lg shadow-riceblue-950/25
                           hover:shadow-xl hover:shadow-riceblue-950/30
              ...
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-3.5
                           ...
                           hover:bg-ricewhite-200 transition-all duration-200"
              >
                Browse Faculty
              </Link>
            </div>
        ...
        <div className="absolute bottom-0 inset-x-0 h-12 bg-gradient-to-t
                        from-riceblue-700 to-transparent pointer-events-none opacity-20" />
      </section>
      ...
      {/* ══════════════════════════════════════════════════════
          STATS
      ══════════════════════════════════════════════════════ */}
      <section className="relative bg-riceblue-700 py-14 px-6 overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 text-center">
            {[
              ...
              <Reveal key={label} from="bottom" delay={i * 80}>
                <div
                  className="font-display font-bold text-ricewhite-100 mb-1.5
                             text-4xl sm:text-5xl"
                >
                  {val}
                </div>
                <div className="text-xs sm:text-sm text-riceblue-300 tracking-wide">
                  {label}
                </div>
              </Reveal>
            ))}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <Reveal from="bottom">
            <div className="text-center mb-14">
              <span className="text-xs font-semibold text-riceblue-700 uppercase
                               tracking-[0.18em]">
                How it works
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {FEATURES.map(({ num, title, body }, i) => (
              <Reveal key={num} from="bottom" delay={i * 100}>
                <div
                  className="group relative p-8 rounded-2xl bg-ricewhite-100 border
                             border-ricewhite-300 hover:border-riceblue-300 hover:bg-ricewhite-50
                             transition-all duration-300 hover:shadow-md
                             hover:shadow-riceblue-900/[0.06]"
                >
                  <div
                    className="font-display font-bold text-[52px] leading-none
                               text-stone-200 mb-5 group-hover:text-riceblue-200
          ...
          <Reveal from="bottom" delay={300}>
            <div className="text-center mt-12">
              <Link
                to="/discover"
                className="inline-flex items-center gap-2 px-7 py-3 bg-riceblue-700
                           text-ricewhite-100 rounded-xl font-semibold text-sm
                           hover:bg-riceblue-600 transition-colors shadow-sm"
              >
                Get matched now →
              </Link>
            </div>
      ...
      {/* ══════════════════════════════════════════════════════
          WHY THIS EXISTS
      ══════════════════════════════════════════════════════ */}
      <section className="bg-ricewhite-200 py-20 px-6">
        <div className="max-w-3xl mx-auto">

          <Reveal from="bottom">
            <div className="flex items-center gap-3 mb-6">
              <span className="w-5 h-px bg-riceblue-700" />
              <span className="text-xs font-semibold text-riceblue-700 uppercase
                               tracking-[0.18em]">
                Why we built this
              </span>
          ...
          <Reveal from="bottom" delay={80}>
            <blockquote
              className="font-display font-bold text-stone-900 leading-tight
                         tracking-tight mb-8 border-l-[3px] border-riceblue-700 pl-6
                         text-[1.9rem] sm:text-[2.5rem]"
            >
              "Finding research opportunities at Rice shouldn't
              require a map."
            </blockquote>
          </Reveal>
          ...
          <Reveal from="bottom" delay={160}>
            <div className="pl-6 space-y-4 text-stone-600 text-[15px] leading-relaxed">
              <p>
                Rice employs hundreds of researchers across 20 STEM
              ...
              <p>
                ...
                at Rice Engineering — the current discovery experience is fragmented
                and frustrating. RiceResearchFinder fixes that.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section className="relative bg-stone-950 py-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row
          ...
          <Reveal from="left" className="flex-1">
            <span className="text-xs font-semibold text-riceblue-400 uppercase
                             tracking-[0.18em] mb-4 block">
              Built for curious Owls
            </span>
            <h2
              className="font-display font-bold text-ricewhite-100 leading-tight
            ...
            <p className="text-stone-400 text-[15px] leading-relaxed max-w-sm">
              ...
              RiceResearchFinder to make that connection faster, more
            ...
            <div className="space-y-7">
              {WHO.map(({ label, text }) => (
                <div key={label} className="flex gap-4">
                  <div className="w-[3px] flex-shrink-0 rounded-full bg-riceblue-700 mt-1" />
                  <div>
                    <div className="text-sm font-semibold text-ricewhite-300 mb-1">
                      {label}
                    </div>
      ...
      {/* ══════════════════════════════════════════════════════
          CTA BANNER
      ══════════════════════════════════════════════════════ */}
      <section className="bg-riceblue-800 py-16 px-6">
        <Reveal>
          <div className="max-w-2xl mx-auto text-center">
            <h2
              className="font-display font-bold text-ricewhite-100 tracking-tight
                         leading-tight mb-4 text-[1.9rem] sm:text-[2.6rem]"
            >
              Ready to find your
              <br />research match?
            </h2>
            <p className="text-riceblue-200 text-sm mb-8 max-w-md mx-auto leading-relaxed">
              Search {loading ? '553+' : faculty.length} faculty profiles across
              Rice Engineering. No account. No forms. Just results.
            </p>
            <Link
              to="/discover"
              className="inline-flex items-center gap-2.5 px-9 py-4 bg-ricewhite-100
                         text-riceblue-800 rounded-xl font-bold text-sm
                         hover:bg-ricewhite-50 transition-all duration-200
                         shadow-lg shadow-riceblue-950/40
                         hover:-translate-y-0.5 active:translate-y-0"
            >
              Find My Research Match
