...
function FilterPanel({ dept, setDept, hasResearchOnly, setHasResearchOnly,
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="relative">
          <select
            ...
            className="w-full text-sm border border-ricewhite-400 rounded-xl px-3.5 py-2.5
                       bg-ricewhite-50 text-stone-700 appearance-none cursor-pointer
                       focus:outline-none focus:ring-2 focus:ring-riceblue-700/30
                       focus:border-riceblue-700 transition-colors pr-8"
          >
      ...
      <div>
        ...
        <label className="flex items-start gap-3 cursor-pointer group">
          <div className="relative mt-0.5 flex-shrink-0">
            ...
            />
            <div className="w-9 h-5 bg-ricewhite-300 rounded-full peer-checked:bg-riceblue-700
                            transition-colors duration-200 border border-ricewhite-400
                            peer-checked:border-riceblue-700" />
      ...
      {hasActive && (
        <div className="pt-1 border-t border-ricewhite-300">
          <button
            onClick={clearAll}
  ...
  return (
    <nav className="flex items-center justify-center gap-1.5 mt-8 mb-4" aria-label="Pagination">
      ...
      <button
        ...
        className="px-3 py-2 text-sm rounded-lg border border-ricewhite-400 text-stone-600
                   hover:border-riceblue-400 hover:text-riceblue-700 hover:bg-riceblue-50
        ...
        p === '...' ? (
          ...
          <button
            ...
            className={`min-w-[36px] px-3 py-2 text-sm rounded-lg border transition-colors font-medium
                        ${p === currentPage
                          ? 'border-riceblue-700 bg-riceblue-700 text-ricewhite-100'
                          : 'border-ricewhite-400 text-stone-600 hover:border-riceblue-400 hover:text-riceblue-700 hover:bg-riceblue-50'
                        }`}
...
export default function Search() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-54px)] bg-ricewhite-100">
      ...
      <div className="relative bg-ricewhite-50 border-b border-ricewhite-300 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-10 pb-8">
          ...
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <span className="text-xs font-semibold text-riceblue-700 uppercase tracking-[0.16em]">
              Faculty Search
            </span>
          </div>
          ...
          <p className="text-[15px] text-stone-500 mb-7">
            ...
            {' '}researchers across 20 STEM departments at Rice.
          </p>
          ...
          <form onSubmit={onSubmit} className="mb-5 relative">
            ...
            >
              <span className="pl-5 flex items-center text-riceblue-700 pointer-events-none
                               flex-shrink-0">
              ...
              <button
                type="submit"
                className="px-7 py-4 bg-riceblue-700 hover:bg-riceblue-600 text-ricewhite-100
                ...
                return (
                  <button
                    ...
                    className={`text-xs px-3.5 py-1.5 rounded-full border
                               ...
                               ${active
                                 ? 'border-riceblue-700 bg-riceblue-700 text-ricewhite-100'
                                 : 'border-ricewhite-400 text-stone-600 bg-white hover:border-riceblue-400 hover:text-riceblue-700 hover:bg-riceblue-50'
                               }`}
                  >
        ...
        <div className="flex gap-7 items-start">
            ...
            <div className="sticky top-5 space-y-3">
              ...
              {hasActive && (
                <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl
                                bg-riceblue-50 border border-riceblue-200">
                  <span className="w-1.5 h-1.5 rounded-full bg-riceblue-700 flex-shrink-0" />
                  <span className="text-xs text-riceblue-700 font-medium">
                    {activeFilterCount > 0
          ...
          <div className="flex-1 min-w-0" ref={topRef}>
            ...
            <div className="lg:hidden mb-5">
              <div className="flex items-center gap-3 flex-wrap">
                <button
                  ...
                  className={`flex items-center gap-2 text-sm px-4 py-2 rounded-xl border
                    ...
                    hasActive
                      ? 'bg-riceblue-50 border-riceblue-300 text-riceblue-700'
                      : 'border-ricewhite-400 text-stone-600 bg-ricewhite-50 hover:border-stone-300'
                  }`}
                >
                  <svg viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5">
                  ...
                  Filters
                  {hasActive && (
                    <span className="w-1.5 h-1.5 rounded-full bg-riceblue-700" />
                  )}
                </button>
                {hasActive && (
                  <button
              ...
              {/* Mobile filter panel */}
              {mobileFiltersOpen && (
                <div className="mt-3 bg-ricewhite-50 rounded-2xl border border-ricewhite-300 p-5">
                  <FilterPanel
                    dept={dept} setDept={setDept}
                    hasResearchOnly={hasResearchOnly}
                    setHasResearchOnly={setHasResearchOnly}
                  ...
                  {results.length === 0 ? (
                    ...
                    <>
                      ...
                      {combinedQuery && (
                        <>
                          {' '}for{' '}
                          <span className="font-semibold text-riceblue-700">
            ...
            {loading && (
              <div className="flex flex-col items-center justify-center py-32 text-center">
                <div
                  className="w-8 h-8 border-2 border-riceblue-700 border-t-transparent
            ...
            {!loading && results.length === 0 && (
              <div className="flex flex-col items-center justify-center py-28 text-center">
                <div
                  className="w-16 h-16 rounded-full bg-ricewhite-200 border border-ricewhite-300
                ...
                {hasActive && (
                  <button
                    onClick={clearAll}
                    className="text-sm px-6 py-2.5 bg-riceblue-700 text-ricewhite-100
                               rounded-xl hover:bg-riceblue-600 transition-colors font-medium"
                  >
                    Clear filters
                  </button>
                )}
