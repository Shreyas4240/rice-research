  ...
  return (
    <div
      ...
      className={`relative rounded-2xl border-2 border-dashed transition-all duration-200
                  ...
                  ${file
                    ? 'border-riceblue-400 bg-riceblue-50 cursor-default'
                    : dragging
                      ? 'border-riceblue-600 bg-riceblue-50 scale-[1.01] cursor-copy'
                      : 'border-ricewhite-400 bg-ricewhite-50 hover:border-riceblue-400 hover:bg-riceblue-50/40 cursor-pointer'
                  }`}
    >
      <input
        ref={inputRef}
      ...
      {file ? (
        <>
          <div className="w-12 h-12 rounded-full bg-riceblue-100 border border-riceblue-200
                          flex items-center justify-center mb-3">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-riceblue-700">
          ...
          <button
            ...
            className="text-xs text-riceblue-700 hover:text-riceblue-600 font-medium underline underline-offset-2"
          >
            Remove file
          </button>
        </>
        ...
        <>
          <div className="w-12 h-12 rounded-full bg-ricewhite-200 border border-ricewhite-300
...
function ProcessingOverlay({ step }) {
  return (
    <div className="absolute inset-0 bg-ricewhite-50/90 backdrop-blur-sm rounded-3xl
      ...
      <div className="flex gap-1 mt-3">
        {STEPS.map((_, i) => (
          <span key={i} className={`w-1.5 h-1.5 rounded-full transition-colors duration-300 ${
            i <= step ? 'bg-riceblue-700' : 'bg-ricewhite-400'
          }`} />
        ))}
      </div>
    </div>
...
export default function Discover() {
  ...
  return (
    <div className="min-h-[calc(100vh-54px)] bg-ricewhite-100 flex items-start justify-center
                    px-4 sm:px-6 py-12">
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-10">
          ...
          <h1 className="font-display font-bold text-stone-900 text-4xl sm:text-5xl
            ...
            <em className="not-italic text-riceblue-700">match.</em>
          </h1>
          <p className="text-[15px] text-stone-600 leading-relaxed max-w-lg">
            ...
            Rice faculty whose work aligns with where you want to go — not just
            where you've been.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full text-sm text-stone-900 bg-ricewhite-50 border-2 border-ricewhite-400
                           rounded-2xl px-4 py-3.5 leading-relaxed resize-none font-sans
                           placeholder-stone-400
                           focus:outline-none focus:ring-0 focus:border-riceblue-700
                    ...
                    <button key={q} type="button" onClick={() => toggleChip(q)}
                            className={`text-[11px] px-3 py-1 rounded-full border transition-all duration-150
                                        ${active
                                          ...
                                          : 'border-ricewhite-400 text-stone-500 bg-white hover:border-riceblue-400 hover:text-riceblue-700 hover:bg-riceblue-50'
                                        }`}>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 px-8 py-4
                         bg-riceblue-700 text-ricewhite-100 rounded-2xl font-semibold text-sm
