...
function EmptyState({ hasFilters, onAdd, onSeed }) {
  ...
  return (
    <div className="py-24 text-center max-w-sm mx-auto">
      <div className="w-14 h-14 rounded-2xl bg-white border border-stone-200
      ...
      <div className="flex flex-col sm:flex-row gap-2 justify-center">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5
                     bg-riceblue-700 text-ricewhite-100 text-sm font-semibold rounded-xl
                     hover:bg-riceblue-600 transition-colors shadow-sm shadow-riceblue-900/20"
        >
          ...
          <div className="flex items-start justify-between gap-4 mb-7 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-riceblue-700 text-ricewhite-100 text-sm font-semibold
                           rounded-xl hover:bg-riceblue-600 transition-colors shadow-sm
