...
import { deptLabel, highlightSegments } from '../utils/search'
...
const DEPT_STYLES = {
  // Engineering
  bioengineering: 'bg-pink-50   text-pink-800   ring-pink-200',
  ...
  mech:           'bg-teal-50   text-teal-800   ring-teal-200',
...
export default function ProfDetail() {
  ...
  const session = (() => {
    try { return JSON.parse(localStorage.getItem('rice_session') || 'null') } catch { return null }
  })()
  ...
  if (!prof) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-24 text-center">
        <div className="w-16 h-16 rounded-full bg-ricewhite-200 border border-ricewhite-300
        ...
        <p className="text-sm text-stone-500 mb-6 max-w-xs mx-auto leading-relaxed">
          ...
          <code className="bg-ricewhite-200 px-1.5 py-0.5 rounded text-xs font-mono">
            {id}
          </code>{' '}
          could not be found.
        </p>
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm px-6 py-2.5
                     bg-riceblue-700 text-ricewhite-100 rounded-xl hover:bg-riceblue-600
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            {/* Profile header */}
            <div className="bg-ricewhite-50 rounded-2xl border border-ricewhite-300 p-7 sm:p-8">
                ...
                <button
                  ...
                  className={`flex-shrink-0 flex items-center gap-1.5 px-4 py-2
                              rounded-xl border text-sm font-medium transition-colors ${
                                saved
                                  ? 'bg-riceblue-50 border-riceblue-300 text-riceblue-700 hover:bg-riceblue-100'
                                  : 'border-ricewhite-400 text-stone-500 hover:border-riceblue-300 hover:text-riceblue-700'
                              }`}
                >
              ...
              <div className="flex items-start gap-5">
                {prof.photo_url ? (
                  <img
                    src={prof.photo_url}
                    alt=""
                    className="w-20 h-20 rounded-xl object-cover flex-shrink-0 ring-1 ring-ricewhite-300"
                  />
                ) : (
                  <div className="w-20 h-20 rounded-xl bg-ricewhite-200 border border-ricewhite-300
            ...
            {/* AI Research Review */}
            {(prof.ai_review || prof.research_summary) && (
              <div className="bg-ricewhite-50 rounded-2xl border border-ricewhite-300 p-7 sm:p-8">
                ...
                <p className="text-[15px] text-stone-700 leading-[1.75]">
                  <Highlight text={prof.ai_review || prof.research_summary} tokens={tokens} />
                </p>
              </div>
            )}
            ...
            {prof.scholar_interests && prof.scholar_interests.length > 0 && (
              <div className="bg-ricewhite-50 rounded-2xl border border-ricewhite-300 p-7 sm:p-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {prof.scholar_interests.map((interest, idx) => (
                    <span
                      key={idx}
                      className="px-3.5 py-1.5 rounded-lg border border-red-200 bg-red-50 text-[#7a1b1b] text-[13px] font-medium"
                    >
                      {interest}
                    </span>
                  ))}
          ...
          <div className="space-y-4">
            ...
            {/* Draft email CTA */}
            <div className="bg-riceblue-700 rounded-2xl p-5">
              <div className="text-[11px] font-semibold text-riceblue-300 uppercase
                              tracking-[0.14em] mb-2">
                Outreach
              </div>
              <p className="text-xs text-riceblue-200 leading-relaxed mb-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5
                           bg-ricewhite-100 text-riceblue-800 text-sm font-semibold
                           rounded-xl hover:bg-ricewhite-50 transition-colors"
              >
              ...
              {!session && (
                <p className="text-[10px] text-riceblue-400 mt-2 text-center leading-relaxed">
                  <Link to="/discover" className="underline underline-offset-2 hover:text-riceblue-300">
                    Upload your resume
                  </Link>{' '}
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 px-4 py-2.5
                          ...
                          ${tracked
                            ...
                            : 'bg-white border-stone-200 text-stone-700 hover:border-riceblue-300 hover:text-riceblue-700 hover:bg-riceblue-50'
                          }`}
            >
            ...
            {/* Links */}
            <div className="bg-ricewhite-50 rounded-2xl border border-ricewhite-300 p-5">
              <div className="text-[11px] font-semibold text-stone-400 uppercase
              ...
              <div className="space-y-2.5">
                {prof.profile_url && (
                  <a
                    ...
                    className="flex items-center justify-between w-full px-4 py-2.5
                               rounded-xl bg-riceblue-700 text-ricewhite-100 text-sm
                               font-medium hover:bg-riceblue-600 transition-colors"
                  >
                    Faculty Profile
                    <ExtIcon />
                  </a>
                ...
                {prof.lab_website && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="flex items-center justify-between w-full px-4 py-2.5
                               rounded-xl border border-ricewhite-400 text-stone-700 text-sm
                               font-medium hover:border-riceblue-400 hover:text-riceblue-700
                               hover:bg-riceblue-50 transition-colors"
                  >
                    Lab Website
                    <ExtIcon />
                  </a>
                ...
                {prof.email && (
                  <a
                    ...
                    className="flex items-center justify-between w-full px-4 py-2.5
                               rounded-xl border border-ricewhite-400 text-stone-700 text-sm
                               font-medium hover:border-stone-300 hover:bg-ricewhite-200
                               transition-colors"
                  >
                    Send Email
                ...
                {prof.phone && (
                  <div>
                    ...
                    <dd className="text-sm text-stone-800">
                      <a href={`tel:${prof.phone}`} className="hover:text-riceblue-700 transition-colors">
                        {prof.phone}
                      </a>
                    </dd>
                  </div>
            ...
            <Link
              ...
              className="flex items-center justify-center gap-1.5 w-full py-2.5
                         rounded-xl border border-ricewhite-300 text-sm text-stone-500
                         hover:bg-ricewhite-200 hover:text-stone-700 transition-colors
                         font-medium"
            >
              ← Back to search
            </Link>
